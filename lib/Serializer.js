            ...
            case "object":
                ...
                if (v instanceof HaxeEnum_1.HaxeEnum && v.constructor) {
                    ...
                    if (this.useEnumIndex) {
                        ...
                        this.buf += "w";
                        this.serialize(constructor_1.enum);
                        this.serialize(constructor_1.tag);
                        this.buf += ":";
                        var params = v.getParams();
                        this.buf += params.length;
                        params.forEach(function (param) {
                ...
                if ((_b = v.constructor) === null || _b === void 0 ? void 0 : _b.name) {
                    try {
