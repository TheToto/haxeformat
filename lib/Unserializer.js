...
var Unserializer = /** @class */ (function () {
    ...
    Unserializer.prototype.unserialize = function () {
        ...
        switch (get(this.pos++)) {
            ...
            case 99: // "c" class instance
                ...
                var co = Object.create(cli.prototype); // creates an empty instance, no constructor is called
                this.cache.push(co);
            ...
            case 115: // "s" Buffers
                ...
                var bytes = Buffer.from(this.buf.substr(this.pos, bytesLen), 'base64');
                this.pos += bytesLen;
            ...
            case 67: // "C" custom
                ...
                var cclo = Object.create(cl.prototype); // creates an empty instance, no constructor is called 
